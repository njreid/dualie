...
void handle_key_remap_msg(uart_packet_t *, device_t *);

/*==============================================================================
 *  Key Remap Sync
 *  Push remap table entries to the other board over UART.
 *==============================================================================*/

void sync_key_remap(uint8_t index, device_t *);
void sync_all_key_remaps(device_t *);
