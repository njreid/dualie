...
Run: `cargo test -p capshift --lib keycodes 2>&1 | head -30`
...
Run: `cargo test -p capshift --lib keycodes`
...
Run: `cargo test -p capshift --lib chord`
...
Run: `cargo test -p capshift --lib actions`
...
Run: `cargo test -p capshift --lib config`
...
Run: `cargo build -p capshift && cargo test -p capshift --lib`
